...
#weather icon for day and night
...
#present the results based on the result json
...
textbox.insert(tk.INSERT,'Enter A City...')
textbox.place(relwidth=0.65, relheight=1)

#button to retrieve weather
submit = tk.Button(frame, text='Check Weather', font=40, command=lambda: get_weather(textbox.get()))
#submit.config(font=)
...
bg_color = 'white'
results = tk.Label(lower_frame, bd=4)
